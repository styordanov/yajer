import { TextDocument, Position, Hover, Range, languages, Disposable, MarkdownString } from 'vscode'
...
export default class HoverProvider implements Disposable {
  ...
  private provideHover(document: TextDocument, position: Position): Hover {
    ...
    const message: MarkdownString = this.hoverMessage.getMessage({
