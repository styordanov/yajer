...
export default class TestsTreeDataProvider implements TreeDataProvider<TestTreeItem> {
  ...
  private onDidChangeTreeDataEventEmitter: EventEmitter<TestTreeItem | undefined> = new EventEmitter<
  ...
  private subscribeOne(contextCommand: TreeViewContextCommands, command: Commands, params: Object = {}) {
